...
g <- create_graph(	fichier = "reprojetrseauxdepersonnages/1990.Gunnm-adj.csv", 
 attr1 = "reprojetrseauxdepersonnages/1990.Gunnm-attr.csv",
 attr2 = "reprojetrseauxdepersonnages/1990.Gunnm-attr2.csv", 
 seuil = 3, 
 connexe = TRUE)
...
# g <- create_graph(	fichier = "reprojetrseauxdepersonnages/1950.Bradbury-adj.csv",
# seuil = 8, 
# connexe = TRUE)
...
pdf("Gunnm.Multiattr2.pdf", height = 14 + g$windows, width = 14)
